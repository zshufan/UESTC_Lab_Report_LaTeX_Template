...
\newcommand{\xiaochuhao}{\fontsize{36pt}{36pt}\selectfont} %小初号，单倍行距
...
\newcommand{\banxiaosi}{\fontsize{13pt}{20pt}\selectfont}  % 半小四, 20pt行距
\newcommand{\xiaosihao}{\fontsize{12pt}{20pt}\selectfont}       % 小四, 20pt行距
...
% 重定义section标题
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\CTEXsetup[format={\CJKfamily{zhhei}\zihao{4}},number={\chinese{section}},name={,、~},aftername={},indent={0pt},beforeskip={6pt},afterskip={6pt},format+={\flushleft}]{section}
\CTEXsetup[format={\Large\bfseries\CJKfamily{zhkai}\zihao{5}},name={（,）},number={\chinese{subsection}},aftername={},indent={22pt},beforeskip={6pt},afterskip={6pt}]{subsection}
...
% 列表设置
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\setlist[enumerate,1]{itemindent=22pt,listparindent=\parindent,itemsep=0mm,partopsep=.7mm,parsep=0ex,labelsep=1.5mm,topsep=0.7mm}
...
\centerline{\\[20pt]\yihao{\fs{实  ~~~~ 验  ~~~~ 报  ~~~~ 告}}}
